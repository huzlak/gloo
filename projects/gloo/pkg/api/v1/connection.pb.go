...
type ConnectionConfig_HttpProtocolOptions struct {
	...
	// (BoolValue) Allows invalid HTTP messaging and headers.
	// When this option is disabled (default), then the whole HTTP connection is terminated upon receiving invalid HEADERS frame.
	// However, when this option is enabled, only the offending stream is terminated.
	OverrideStreamErrorOnInvalidHttpMessage bool `protobuf:"varint,25,opt,name=override_stream_error_on_invalid_http_message,json=overrideStreamErrorOnInvalidHttpMessage,proto3" json:"override_stream_error_on_invalid_http_message,omitempty"`
}
...
func (x *ConnectionConfig_HttpProtocolOptions) GetOverrideStreamErrorOnInvalidHttpMessage() bool {
	if x != nil {
...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_connection_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0xec, 0x0b, 0x0a, 0x10, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e,
	...
	0x69, 0x76, 0x65, 0x49, 0x6e, 0x74, 0x65, 0x72, 0x76, 0x61, 0x6c, 0x1a, 0x93, 0x04, 0x0a, 0x13,
	...
	0x6e, 0x12, 0x5e, 0x0a, 0x2d, 0x6f, 0x76, 0x65, 0x72, 0x72, 0x69, 0x64, 0x65, 0x5f, 0x73, 0x74,
	...
	0x67, 0x65, 0x18, 0x19, 0x20, 0x01, 0x28, 0x08, 0x52, 0x27, 0x6f, 0x76, 0x65, 0x72, 0x72, 0x69,
	...
	0x65, 0x22, 0x4e, 0x0a, 0x1c, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x73, 0x57, 0x69, 0x74, 0x68,
	0x55, 0x6e, 0x64, 0x65, 0x72, 0x73, 0x63, 0x6f, 0x72, 0x65, 0x73, 0x41, 0x63, 0x74, 0x69, 0x6f,
